...
<div class="row">
 ...
 {{Form::text('ModifierGroupName',null,['class' => 'form-control'])}}
 </div>
 
 <div class="form-group">
  {{Form::label('MinSelectedItems','Min. Selected Items:') }}
  {{Form::number('MinSelectedItems',0,['class' => 'form-control'])}}
 </div>
 
 <div class="form-group">
  {{Form::label('MaxSelectedItems','Max. Selected Items:') }}
  {{Form::number('MaxSelectedItems',0,['class' => 'form-control'])}}
 </div>
...
<!-- Start the ProductModifiers Panel -->
 <div class="col-md-4">
 {{Form::hidden('num_modifiers',0,['id' => 'num_modifiers'])}}
 @include('productmodifiergroup.modifierforminput')
 </div>
