...
<div class="panel panel-primary">
 ...
 <div class="panel-body">
  {{Form::open(array('route' => array('productmodifiergroup.store'),'method'=>'post'))}}

  <!-- Form Body ProductModifierGroup -->
  @include('productmodifiergroup.groupforminput')
  <!-- End Form Body ProductModifierGroup -->
 </div> 
  <!-- Order Mapping -->
   </div>

   @include('productmodifiergroupmap.create')
...
$(document).ready(function(){
	...
	// DomElem = new DomElem(type of elem,body of elem,attributes,nodes);
	   ...
	   emptytd.addNode(
	    new DomElem('input','',{'type':'hidden','name':'modifier[][MaxQuantity]','id':'modifier[][MaxQuantity]','value':0}).get()
	   );
	   emptytr.addNode(emptytd.get());
