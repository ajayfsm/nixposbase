...
<div class="panel panel-default">
  ...
  <div class="panel-body">
   ...
   <div class="col-md-6">
   	<button type="button" class="btn btn-primary btn-sm" id="addMapItems" role="button">Add</button>
   </div>
   <div class="col-md-6">
    	<button type="button"  class="btn btn-primary btn-sm" id="removeMapItems" role="button">Remove</button>
   </div>
   </div>
   ...
   @include('productmodifiergroupmap.inputform')
   </tbody>
...
$("#addMapItems").on("click",function(){
	...
	for(var product in catdata){
		...
		sel1.addNode(new DomElem("option",cat,{'value':cat.toString()}).get());
	}	   
