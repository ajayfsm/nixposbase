...
class UpdateProductGroupModifierRequest extends Request
{
    /**
    ...
    {
        return [
            'ModifierGroupName' => 'string|unique:product_modifier_groups,ModifierGroupName',
	    ...
	    'ColumnCount' => 'sometimes|numeric|min:0',
	    'ButtonHeight' => 'sometimes|numeric|min:0',
